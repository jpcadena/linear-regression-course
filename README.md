...
<h3 align="center">Linear Regression Course</h3>

  <p align="center">
    Description for Linear Regression Course
    <br />
    <a href="https://github.com/jpcadena/linear-regression-course"><strong>Explore the docs »</strong></a>
    <br />
  </p>
</div>
...
1. Clone the **repository**
    ```
    git clone https://github.com/jpcadena/linear-regression-course.git
    ```
2. Change the directory to **root project**
    ```
    cd linear-regression-course
    ```
...
E-mail: [Juan Pablo Cadena Aguilar](mailto:jpcadena@espol.edu.ec?subject=[GitHub]linear-regression-course)
